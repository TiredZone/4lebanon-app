...
import { SITE_CONFIG, FOOTER_NAV, SOCIAL_LINKS, CONTACT_EMAIL } from '@/lib/constants'
  ...
  return (
    <footer className="bg-primary text-white">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:py-12">
        <div className="grid gap-6 text-center md:grid-cols-3 md:gap-8 md:text-right">
          {/* Logo and Social */}
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex justify-center gap-2 sm:gap-3 md:justify-start">
              ...
              <SocialLink href={SOCIAL_LINKS.whatsapp} icon="whatsapp" />
            </div>
          </div>
          ...
          {/* Contact */}
          <div>
            <h3 className="mb-3 text-base font-bold sm:mb-4 sm:text-lg">تواصل معنا</h3>
