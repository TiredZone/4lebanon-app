...
async function getHomepageData() {
  ...
  // Recent articles for على مدار الساعة (left sidebar)
  ...
  // Important/Featured articles (main area)
...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* المانشيت Banner */}
      <div className="bg-[#830005] py-3">
        <div className="container mx-auto px-4">
          <HeadlineScroller headlines={data.headlines} />
        </div>
      </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12 grid grid-cols-1 gap-8 lg:grid-cols-[300px_1fr]">
          ...
          <AnimatedSection>
            <div className="mb-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <h2 className="text-2xl font-bold text-[#c61b23] md:text-3xl">الأخبار المهمة</h2>
              </div>
              <Link href="/important" className="text-sm font-bold text-[#c61b23] hover:underline">
                ← المزيــــــد
              </Link>
            </div>
                  ...
                  <AnimatedCard key={article.id} delay={index * 0.1}>
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {article.excerpt_ar && (
                          <p className="mb-3 line-clamp-2 hidden text-xs leading-relaxed text-gray-600 md:block md:text-sm">
                            {article.excerpt_ar}
                          </p>
                        )}
        ...
        <div className="space-y-12 md:space-y-16">
          ...
          <section className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
            ...
            <div>
              <div className="mb-4 flex items-center justify-between">
                <Link
                  href="/section/radar"
                  className="text-xs font-bold text-[#c61b23] hover:underline md:text-sm"
                >
                  ← المزيــــــد
                </Link>
                <h2 className="text-xl font-bold text-[#c61b23] md:text-2xl lg:text-3xl">رادار</h2>
              </div>
          ...
          <section>
            <div className="mb-4 flex items-center justify-between">
              ...
              <h2 className="text-xl font-bold text-[#c61b23] md:text-2xl lg:text-3xl">خــاص</h2>
            </div>
            <div className="mb-4 h-0.5 bg-[#c61b23] md:mb-6"></div>
